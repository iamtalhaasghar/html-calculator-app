function numberButtonClicked(params) {
    document.getElementById('screen').textContent += params;
}

function operationButtonClicked(params) {
    screen = document.getElementById('screen');
    if(params === '='){
        document.getElementById('output').textContent = screen.textContent + " = " + evaluator(screen.textContent);
        screen.textContent = "";
    }else{
        screen.textContent += params;
    }
}

// https://github.com/gregfrazier/expeval-js
